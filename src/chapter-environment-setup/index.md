...
{% capture ch2_quiz_q %}
Q1. AtCoderアカウント作成時のユーザー名の注意点を2つ  
Q2. 安全なパスワードの条件を2つ  
Q3. 認証メールが届かないときの確認手順を2つ  
Q4. 初回ログイン後に見るべき情報は？  
Q5. 次章へ向けて準備すべきことは？
{% endcapture %}
{% include panel.html type="steps" title="📘 質問" content=ch2_quiz_q %}

{% capture ch2_points %}
• ユーザー名は個人特定を避け、覚えやすく一貫性あるもの  
• 強固なパスワードと復旧手段（メール）の確保  
• 公式のルール/チュートリアルを目通ししておく
{% endcapture %}
{% include panel.html type="info" title="✅ 要点チェック" content=ch2_points %}
